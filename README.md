...
- **Klantdossier** met bedrijfsgegevens, **meerdere contactpersonen** per bedrijf
  (naam, functie, telefoon, e-mail) en een tijdlijn van bezoeken: datum, welke
...
test/            267 tests, die allemaal op beide databases draaien
```
