...
export const api = {
  ...
  nieuwContact: (id, data) => vraag(`/api/klanten/${id}/contacten`, { method: 'POST', body: data }),
  wijzigContact: (id, data) => vraag(`/api/contacten/${id}`, { method: 'PATCH', body: data }),
  verwijderContact: (id) => vraag(`/api/contacten/${id}`, { method: 'DELETE' }),
